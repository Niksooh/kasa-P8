...
import '../styles/starsStyles.css';

export default function Stars({ rating }) {

    const filledStars = Math.floor(rating);
    const percentageFilled = (rating - filledStars) * 100;

    return (
        <div className="housing_rating">
            <div className="stars_container">
                <div className="stars_filled" style={{ width: `${percentageFilled}%` }}>
                    {[...Array(5)].map((_, index) => (
                        <svg key={index} className="star_icon" viewBox="0 0 25 24" xmlns="http://www.w3.org/2000/svg">
